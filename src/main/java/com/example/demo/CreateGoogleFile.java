...
public class CreateGoogleFile {
	...
	public static void main(String[] args) throws IOException {
		...
		java.io.File uploadFile = new java.io.File("C:\\Users\\asad.ali\\Documents\\number_plate.csv");

		// Create Google File:

		File googleFile = createGoogleFile("1LCAmohZADlihMpvKfF3AUMTp-i8uW3xB", "text/csv", uploadFile.getName(), uploadFile);
